...
ALTER TABLE document_info
    ADD COLUMN knowledge_id BIGINT DEFAULT NULL COMMENT '知识库ID，关联knowledge_base.id' AFTER id;
...
ALTER TABLE chat_session
    ADD COLUMN knowledge_id BIGINT DEFAULT NULL COMMENT '绑定的知识库ID，RAG对话使用' AFTER model_name;
