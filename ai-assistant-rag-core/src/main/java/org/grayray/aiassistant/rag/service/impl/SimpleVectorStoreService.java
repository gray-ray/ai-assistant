...
public class SimpleVectorStoreService extends SimpleVectorStore implements VectorStoreService {
    ...
    private void loadVectorsFromDisk() {
        ...
        VectorStorePersistenceManager.DocumentIdValidator validator = docId -> true;
    ...
    public void saveAll(List<EmbeddedChunk> embeddedChunks) {
        ...
        for (EmbeddedChunk ec : embeddedChunks) {
            ...
            String chunkId = chunk.getChunkId() != null && !chunk.getChunkId().isBlank()
                    ...
                    chunk.getDocumentId(), chunk.getChunkVersion() != null ? chunk.getChunkVersion() : 1, chunk.getChunkIndex());
            ...
            metadata.put("chunkVersion", chunk.getChunkVersion() != null ? chunk.getChunkVersion() : 1);
            metadata.put("chunkIndex", chunk.getChunkIndex());
            metadata.put("totalChunks", chunk.getTotalChunks());
            metadata.put("pageNumber", chunk.getPageNumber() != null ? chunk.getPageNumber() : 0);
    ...
    private RetrievedChunk toRetrievedChunk(SimpleVectorStoreContent content, double score) {
        ...
        return RetrievedChunk.builder()
                ...
                .knowledgeId(getLongMeta(meta, "knowledgeId"))
